			...
			<div class="card-body">
				<form action="user-login" method="post">
					<div class="form-group">
						<label class="">Passcode (secret for Admin)</label> <input
							type="username" class="form-control" name="login-password"
		...
		<div class="card w-50 mx-auto my-5">
			...
			<div class="card-body">
				<form action="create-account" method="post">
					<div class="form-group">
						<label class="">Enter a Passcode</label> <input type="password"
							class="form-control" name="create-account-password" placeholder="Passcode"
							required>
					</div>
					<br>
					<div class="text-center">
